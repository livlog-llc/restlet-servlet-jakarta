...
public class ServletLogger extends Logger {
    ...
    private volatile jakarta.servlet.ServletContext context;
     ...
     */
    public ServletLogger(final jakarta.servlet.ServletContext context) {
     ...
     */
    private jakarta.servlet.ServletContext getContext() {
    ...
    public void log(final LogRecord record) {
        ...
        if (record.getThrown() != null) {
            this.getContext().log(record.getMessage(), record.getThrown());
        } else {
            this.getContext().log(record.getMessage());
        }
    }
